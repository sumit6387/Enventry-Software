          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                @endphp
                <h4>Total Amount : <span id="totalamount"> ₹ 0</span> <span><a href="{{ url('/invoice/'.$id.'?text=sales') }}" id="sales_report" class="btn btn-primary">Sale Invoice</a></span> <span><a id="invoice" href="{{ url('/invoice/'.$id.'?text=slip') }}" class="btn btn-primary">Tax Invoice</a></span></h4>
              </div>
              <div class="col-md-7">
