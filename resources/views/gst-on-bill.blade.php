...
<head>
  ...
  <title>Inventry Software | GST On Bill</title>
...
<div class="wrapper">
  ...
  @include('layouts.sidebar',["title"=>"GST"])
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <span><button class="btn btn-primary" style="margin-left: 90%;" data-toggle="modal" data-target="#exampleModal">Add GST</button></span>
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->gst }}%</td>
                        <td><button class="btn btn-primary mx-3">Edit</button><span><a href="{{ url('/deleteGST/'.$item->id) }}" class="btn btn-danger">Delete</a></span></td>
                    </tr>
                    @endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="quickForm" action="{{ url('/addgst') }}" method="POST" class="database_operation">
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Condtion</label>
              <select class="form-control select2" name="condition" id="category" style="width: 100%;">
